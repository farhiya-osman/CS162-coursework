...
using namespace std;
/********************************************************************* 
** Program Filename: assignment5.tar
** Author: Farhiya Osman 
** Date: 06/07/2020
** Description: This function test get_length of a node, push_back,push_front,print,clear,sort_ascending,sort_descending
** Input:N/A
** Output: If the function passed or failed 
*********************************************************************/
