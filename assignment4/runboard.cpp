...
/*******************************************************************
 * ** Function: runboard(int bsize)
 * ** Description:    initializes all the points 
 * ** Parameters:none  
 * ** Pre-conditions: none 
 * ** Post-conditions: none
 * *******************************************************************/
runboard::runboard(int bsize){ //initialize array with command line arguments as the size 
       gsize = bsize; 
 ...
 * ** Post-conditions: none
 * *******************************************************************/
void runboard::print_board(int bsize){
  int count = 0; 
  room b;
...
string runboard::warning(string b){
   bats bs; 
   pit ps; 
   gold g; 
   wumpus ws; 
 ...
 * ** Post-conditions: none
 * *******************************************************************/
void runboard::adventurer_direction(){
  string achoice; 
 ...
 * ** Post-conditions: none
 * *******************************************************************/
void runboard::set_board(){
  srand(time(NULL)); 
  int rand1,rand2; 
   int randval = rand()%gsize + 1;
  for(int l = 0; l<1; l++){ //adventurer
    int rand1s = rand() % 2;  //randomizes a position for the adventurer on the grid 
    int rand2s = rand() % 2; 
   ...
   for(int l = 0; l<1; l++){ //wumpus 
    int rand1b = (rand() % 4)+2;  //randomizes places withint he grid for the wumpus 
    int rand2b = (rand() % 4)+2; 
    //cout << rand1 << " wumpus " << rand2 << endl; 
    if(vec[rand1b][rand2b].get_eventsnum() == " "){
       vec[1][rand2b].set_eventsnum("w"); 
    }
  }
 ...
 * ** Post-conditions: none
 * *******************************************************************/
void runboard::update_board(int bsize){
  cout << endl; 
   for(int i = 0; i<bsize; i++){
    for(int l = 0; l<bsize; l++){

       cout << "|" << vec[i][l].get_eventsnum() ;  
    }
    cout << endl; 
  }
  for(int i = 0; i<gsize ; i++){
